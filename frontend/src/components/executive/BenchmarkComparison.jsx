...
// "exact" only appears for small scenarios (<=10 jobs) - filtered out below
// when absent, never faked.
const METHOD_ORDER = ['greedy', 'pso', 'ga', 'qpso', 'qpso_ls', 'exact'];
      ...
      <div className="flex items-start justify-between flex-wrap gap-2">
        <div className="space-y-1">
          ...
          <p className="text-xs text-gray-500 max-w-xl">
            The same delivery job, solved by {series.length} different planning methods. Shorter bars are better.
            {benchmarkData.results.exact && ' "Best possible" is the mathematically optimal plan, computable only for small jobs like this one.'}
          </p>
        </div>
